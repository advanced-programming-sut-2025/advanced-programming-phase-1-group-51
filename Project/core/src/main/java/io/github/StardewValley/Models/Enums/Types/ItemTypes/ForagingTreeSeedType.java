...
public enum ForagingTreeSeedType implements ItemType{
    ...
    ForagingTreeSeedType(Season[] season, String name, int value) {
    ...
    public static ForagingTreeSeedType findTreeTypeByName(String name) {
        for (ForagingTreeSeedType tree : ForagingTreeSeedType.values()) {
