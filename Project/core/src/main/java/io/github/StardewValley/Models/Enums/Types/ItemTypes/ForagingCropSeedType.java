...
public enum ForagingCropSeedType implements ItemType{
    ...
    public static ForagingCropSeedType findCropBySeed(String seed) {
        for (ForagingCropSeedType crop : ForagingCropSeedType.values()) {
