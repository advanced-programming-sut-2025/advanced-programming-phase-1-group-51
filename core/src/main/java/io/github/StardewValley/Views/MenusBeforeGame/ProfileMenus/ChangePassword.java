...
import io.github.StardewValley.Controllers.MenuControllers.ProfileControllers.ChangePasswordController;
...
public class ChangePassword implements Screen {
    ...
    public void show() {
        ...
        emailRow.add(new Label("New Password:", skin)).width(250).right().padRight(20);
    ...
    public void render(float delta) {
        ...
        stage.draw();
        controller.handlePasswordMenuButtons();
    }
