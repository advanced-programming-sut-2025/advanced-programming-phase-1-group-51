...
public abstract class BaseInventoryMenu implements Screen {
    ...
    public BaseInventoryMenu(GameController gameController, Skin skin, String title) {
        this.skin = skin;
