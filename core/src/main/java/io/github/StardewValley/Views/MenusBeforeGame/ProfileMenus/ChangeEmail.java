...
import io.github.StardewValley.Controllers.MenuControllers.ProfileControllers.ChangeEmailController;
import io.github.StardewValley.Main;

public class ChangeEmail implements Screen {
    private Stage stage;
    ...
    private final TextField newEmailField;
    public Table table;
    private final ChangeEmailController controller;

    public ChangeEmail(ChangeEmailController controller, Skin skin) {
        this.controller = controller;
        this.skin = skin;
        this.submitButton = new TextButton("Submit", skin);
        this.backButton = new TextButton("Back", skin);
        this.menuTitle = new Label("Change Email", skin);
        this.errorLabel = new Label("", skin);
        this.errorLabel.setColor(1, 0, 0, 1);
        this.newEmailField = new TextField("", skin);
    ...
    public void show() {
        ...
        emailRow.add(newEmailField).width(500);
        ...
        stage.setKeyboardFocus(newEmailField);
    }
    ...
    public void render(float delta) {
        ...
        stage.draw();
        controller.handleEmailMenuButtons();
    }
    ...
    public TextField getNewEmailField() {
