...
public enum CookingRecipes {
    ...
    BAKED_FISH("Baked Fish", 0, 0, 0, 0, FoodType.BAKED_FISH,
        new Slot[]{new Slot(new Fish(Quality.DEFAULT, FishType.SARDINE), 1), new Slot(new Fish(Quality.DEFAULT, FishType.SALMON), 1), new Slot(new Food(FoodType.WHEAT), 1)}),
    ...
    SALMON_DINNER("Salmon Dinner", Integer.MAX_VALUE, Integer.MAX_VALUE, Integer.MAX_VALUE, Integer.MAX_VALUE, FoodType.SALMON_DINNER,
        new Slot[]{new Slot(new Fish(Quality.DEFAULT, FishType.SALMON), 1), new Slot(new Food(FoodType.AMARANTH), 1), new Slot(new Food(FoodType.KALE), 1)}),
    ...
    DISH_OF_THE_SEA("Dish 'O The Sea", 0, 0, 0, 2, FoodType.DISH_OF_THE_SEA,
        new Slot[]{new Slot(new Fish(Quality.DEFAULT, FishType.SARDINE), 2), new Slot(new Food(FoodType.HASH_BROWNS), 1)}),
