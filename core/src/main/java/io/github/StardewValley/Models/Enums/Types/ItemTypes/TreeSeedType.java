...
public enum TreeSeedType implements ItemType{
    ...
    TreeSeedType(Season[] season, String name, int value) {
    ...
    public static TreeSeedType findTreeSeedTypeByName(String name) {
        for (TreeSeedType tree : TreeSeedType.values()) {
