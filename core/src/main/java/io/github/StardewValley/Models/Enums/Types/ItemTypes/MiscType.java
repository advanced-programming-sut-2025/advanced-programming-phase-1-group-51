...
public enum MiscType implements ItemType{
    ...
    LARGE_EGG("Large Egg", 50, false, false),
    ...
    LARGE_MILK("Large Milk", 190, false, false),
    GOAT_MILK("Goat Milk", 225, false, false),
    LARGE_GOAT_MILK("Large Goat Milk", 345, false, false),
    ...
    MiscType(String name, int value, boolean isArtisanBlock, boolean isPlacable) {
        this.name = name;
        this.value = value;
    ...
    public static MiscType getElseTypeByName(String name) {
