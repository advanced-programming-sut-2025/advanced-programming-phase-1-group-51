...
public enum PierreGeneralStoreProducts implements StoreProducts{
    ...
    GRASS_STARTER_P("Pierre Grass Starter", "Place this on your farm to start a new patch of grass.", CropSeedType.GRASS_STARTER, 100, 100, Double.POSITIVE_INFINITY, Season.values()),
    ...
    CAULIFLOWER_SEEDS("Cauliflower Seeds", "Plant these in the spring. Takes 12 days to produce a large cauliflower.", CropSeedType.CAULIFLOWER_SEEDS, 80, 120, 5, new Season[]{Season.SPRING}),
    POTATO_SEEDS("Potato Seeds", "Plant these in the spring. Takes 6 days to mature, and has a chance of yielding multiple potatoes at harvest.", CropSeedType.POTATO_SEEDS, 50, 75, 5, new Season[]{Season.SPRING}),
